...
public class PairedInstancesIterator extends GeneralInstancesIterator {
    ...
    public Pair<Pair<Instances, Instances>, Double> _next() {
        Pair<Instances, Instances> instancesPair;
        Pair<Pair<Instances, Instances>, Double> toReturn;
        // Treat a special case of only two elements in the array
        if (this.splittedInstances.length == 2) {
            instancesPair = new Pair<Instances, Instances>(this.splittedInstances[0],
                    this.splittedInstances[1]);
            toReturn = new Pair<Pair<Instances, Instances>, Double>(instancesPair, 1.0);
        } else {
            ...
            instancesPair = new Pair<Instances, Instances>(i1, i2);
            toReturn = new Pair<Pair<Instances, Instances>, Double>(instancesPair,
